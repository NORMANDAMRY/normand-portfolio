...
export default function About() {
  return (
    <section id="about" className="py-20 bg-deep/50">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <div className="flex items-center gap-3 p-4 bg-card rounded-xl border border-border">
              ...
              <div>
                ...
                <p className="font-medium text-gray-100">Bangi, Selangor</p>
              </div>
            </div>
            <div className="flex items-center gap-3 p-4 bg-card rounded-xl border border-border">
              <Calendar className="w-5 h-5 text-cyan-400 shrink-0" />
              <div>
                <p className="text-sm text-muted-light">Availability</p>
                <p className="font-medium text-gray-100">September 2026</p>
              </div>
            </div>
            <div className="flex items-center gap-3 p-4 bg-card rounded-xl border border-border">
              <GraduationCap className="w-5 h-5 text-cyan-400 shrink-0" />
              <div>
                <p className="text-sm text-muted-light">Education</p>
                <p className="font-medium text-gray-100">UniKL MIIT</p>
              </div>
            </div>
          </div>
